		...
		<div class="grid">
            ...
            <div id="header-left-menu" class="grid__item large--ten-twelfths text-right hd-menu">
            	<div id="header-main-mn" class="hd-navbar">
                	<ul id="menu-menu-chinh-1" class="no-bullets"><li   class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-2 current_page_item menu-item-19 current-menu-ancestor" ><a href="{{route('trang_chu')}}">Trang chủ</a></li><li   class="menu-item menu-item-type-post_type menu-item-object-page menu-item-130" ><a href="https://at10.mediawz.com/gioi-thieu/">Giới thiệu</a></li><li   class="menu-item menu-item-type-post_type menu-item-object-page menu-item-131" ><a href="https://at10.mediawz.com/san-pham/">Sản phẩm</a></li><li   class="menu-item menu-item-type-post_type menu-item-object-page menu-item-133" ><a href="https://at10.mediawz.com/lien-he/">Liên hệ</a></li><li   class="menu-item menu-item-type-post_type menu-item-object-page menu-item-134" ><a href="https://at10.mediawz.com/huong-dan-mua-hang/">Hướng dẫn</a></li></ul>                </div>
                <!--#header-main-mn-->
...
@foreach($sp_loai1 as $l1)
<div class="md-pd-left10 grid__item large--one-quarter medium--one-third small--one-half">
	<div class="product-item">
        <div class="product-img">
            <a href="{{route('chi_tiet_san_pham', $l1->id)}}">
               <img width="260" height="260" src="image/products/{{$l1->image}}" class="attachment-thumb_260x260 size-thumb_260x260 wp-post-image" alt="{{$l1->name}}" srcset="image/products/{{$l1->image}}" sizes="100vw" />            </a>
        </div>
        <div class="product-info">
            <div class="product-title">
            	<a href="{{route('chi_tiet_san_pham', $l1->id)}}">{{$l1->name}}</a>
            </div>
                        <div class="product-price clearfix">
                            @if($l1->promotion_price != 0)
                                <span class="current-price"><span class="woocommerce-Price-amount amount">{{$l1->promotion_price}}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></span>
                                <span class="original-price"><s><span class="woocommerce-Price-amount amount">{{$l1->unit_price}}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></s></span>
                		    @else
                                <span class="current-price"><span class="woocommerce-Price-amount amount">{{$l1->unit_price}}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></span>
                            @endif
                        </div>
...
@foreach($sp_loai2 as $l2)
<div class="md-pd-left10 grid__item large--one-quarter medium--one-third small--one-half">
	<div class="product-item">
        <div class="product-img">
            <a href="{{route('chi_tiet_san_pham', $l2->id)}}">
               <img width="260" height="260" src="image/products/{{$l2->image}}" class="attachment-thumb_260x260 size-thumb_260x260 wp-post-image" alt="{{$l2->name}}" srcset="image/products/{{$l2->image}} 480w" sizes="100vw" />            </a>
        </div>
        <div class="product-info">
            <div class="product-title">
            	<a href="{{route('chi_tiet_san_pham', $l2->id)}}">{{$l2->name}}</a>
            </div>
                        <div class="product-price clearfix">
                            @if($l2->promotion_price != 0)
                            <span class="current-price"><span class="woocommerce-Price-amount amount">{{$l2->promotion_price}}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></span>
                            <span class="original-price"><s><span class="woocommerce-Price-amount amount">{{$l2->unit_price}}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></s></span>
                        @else
                            <span class="current-price"><span class="woocommerce-Price-amount amount">{{$l2->unit_price}}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></span>
                        @endif
                			</div>
            <div class="product-actions text-center clearfix">
                <a href="{{route('chi_tiet_san_pham', $l2->id)}}">
...
@foreach($sp_loai3 as $l3)
<div class="md-pd-left10 grid__item large--one-quarter medium--one-third small--one-half">
	<div class="product-item">
        <div class="product-img">
            <a href="{{route('chi_tiet_san_pham', $l3->id)}}">
               <img width="260" height="260" src="image/products/{{$l3->image}}" class="attachment-thumb_260x260 size-thumb_260x260 wp-post-image" alt="{{$l3->name}}" srcset="image/products/{{$l3->image}} 480w" sizes="100vw" />            </a>
        </div>
        <div class="product-info">
            <div class="product-title">
            	<a href="{{route('chi_tiet_san_pham', $l3->id)}}">{{$l3->name}}</a>
            </div>
                        <div class="product-price clearfix">
                            @if($l3->promotion_price != 0)
                            <span class="current-price"><span class="woocommerce-Price-amount amount">{{$l3->promotion_price}}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></span>
                            <span class="original-price"><s><span class="woocommerce-Price-amount amount">{{$l3->unit_price}}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></s></span>
                        @else
                            <span class="current-price"><span class="woocommerce-Price-amount amount">{{$l3->unit_price}}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></span>
                        @endif
                			</div>
            <div class="product-actions text-center clearfix">
                <a href="{{route('chi_tiet_san_pham', $l3->id)}}">
                	...
                	<div class="wrapper">
						<div class="inner">
                        	<div class="gallery-slider grid">
                                        ...
                                        <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_1.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery6336a6816661e" data-caption="gallery 1">
                                            <img src="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_1-360x255.jpg" alt="">
                                            <div class="overlay"></div>
                                        </a>
                                    </div>
								 									<div class="gallery-item grid__item">
                                        <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_2.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery6336a6816661e" data-caption="gallery 1">
                                            <img src="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_2-360x255.jpg" alt="">
                                            <div class="overlay"></div>
                                        </a>
                                    </div>
								 									<div class="gallery-item grid__item">
                                        <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_4.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery6336a6816661e" data-caption="gallery 1">
                                            <img src="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_4-360x255.jpg" alt="">
                                            <div class="overlay"></div>
                                        </a>
                                    </div>
								 									<div class="gallery-item grid__item">
                                        <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_5.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery6336a6816661e" data-caption="gallery 1">
...
<li id="menu-item-65" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-65"><a href="https://at10.mediawz.com/huong-dan-mua-hang/">Hướng dẫn mua hàng</a></li>
					...
					<h3 class="footer-title">GALLERY</h3>					<div class="grid gallery-wrapper mg-left-15">
                                ...
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img3.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery6336a6816b543" data-caption="gallery 1">
                                        ...
                                        <div class="overlay"></div>
                                                  	...
                                                  	<div class=" grid__item large--one-third medium--one-third small--one-third  pd-left15">
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img2.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery6336a6816b543" data-caption="gallery 1">
                                        ...
                                        <div class="overlay"></div>
                                                  	...
                                                  	<div class=" grid__item large--one-third medium--one-third small--one-third  pd-left15">
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img1.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery6336a6816b543" data-caption="gallery 1">
